  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <p className="text-lg mb-4">
        ...
        and emotional aspects of music, which continues to shape my approach to
        every project.
      </p>
      <p className="text-lg mb-4">
      ...
      <p className="text-lg mb-4">
        My love for a great mix started before I even knew it. Without realizing
      ...
      <p className="text-lg mb-4">
        ...
        Every song, every project, is unique, and I take pride in crafting mixes
        that not only sound great but also resonate emotionally and stand the
        test of time.
      </p>
    </div>
  );
